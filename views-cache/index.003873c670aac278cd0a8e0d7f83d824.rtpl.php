                        ...
                        <div class="product-carousel">
                            <div class="single-product">
                                <div class="product-f-image">
                                    <img src="res/site/img/product-1.jpg" alt="Produto 1">
                                    <div class="product-hover">
                                        <a href="#" class="add-to-cart-link"><i class="fa fa-shopping-cart"></i>Add to cart</a>
                                        <a href="#" class="view-details-link"><i class="fa fa-link"></i>See details</a>
                                    </div>
                                </div>
                                <h2><a href="#">Sansung Galaxy s5 - 2015</a></h2>
                            ...
                            <div class="single-product">
                                <div class="product-f-image">
                                    <img src="res/site/img/product-2.jpg" alt="Produto 2">
                                    <div class="product-hover">
                                        <a href="#" class="add-to-cart-link"><i class="fa fa-shopping-cart"></i> Add to cart</a>
                                        <a href="#" class="view-details-link"><i class="fa fa-link"></i>See details</a>
                                    </div>
                            ...
                            <div class="single-product">
                                <div class="product-f-image">
                                    <img src="res/site/img/product-4.jpg" alt="Produto 4">
                                    <div class="product-hover">
                                        <a href="#" class="add-to-cart-link"><i class="fa fa-shopping-cart"></i> Add to cart</a>
                                        <a href="#" class="view-details-link"><i class="fa fa-link"></i>See details</a>
                                    </div>
                                ...
                                <div class="product-carousel-prince">
                                    <ins>$200.00</ins> <del>$225.00</del>
                                </div>
                            </div>
                            <div class="single-product">
                                <div class="product-f-image">
                                    <img src="res/site/img/product-5.jpg" alt="Produto 5">
                                    <div class="product-hover">
                                        <a href="#" class="add-to-cart-link"><i class="fa fa-shopping-cart"></i>Add to cart</a>
                                        <a href="#" class="view-details-link"><i class="fa fa-link"></i>See details</a>
                                    </div>
                                ...
                                <h2>IPhone 6</h2>
                                <div class="product-carousel-price">
                                    <ins>$1200.00</ins> <del>$1350.00</del>
                                </div>
                            </div>
                            <div class="single-product">
                                <div class="product-f-image">
                                    <img src="res/site/img/product-6.jpg" alt="Produto 6">
                                    <div class="product-hover">
                                        <a href="#" class="add-to-cart-link"><i class=" fa fa-shopping-cart"></i>Add to cart</a>
                                        <a href="#" class="view-details-link"><i class="fa fa-link"></i>See details</a>
                                    </div>
                                </div>
                                <h2>Sansung Gallaxy note 4</h2>
                                <div class="product-carousel-price">
                                    <ins>$400.00</ins>
                                </div>
                            </div>
